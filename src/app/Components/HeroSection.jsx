    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] text-base text-lg lg:text-xl mb-6">
            I&apos;m a developer
          </p>
          <div>
            ...
            <button className="px-1 py-1 rounded-full sm:w-fit bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-state-800 text-white mt-3">
